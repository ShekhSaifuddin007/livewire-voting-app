...
>
    ...
    <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
        <div class="flex-none mx-2 md:mx-0">
            <a href="{{ route('ideas.show', $idea) }}" class="flex idea-link items-start space-x-6">
                <img src="{{ $idea->user->photoUrl() }}" alt="avatar" class="w-14 h-14 rounded-xl">

                <span class="block md:hidden text-lg md:text-xl mt-2 md:mt-0 font-semibold">
                    <span class="idea-link hover:underline">{{ $idea->title }}</span>
                </span>
            </a>
        </div>

        <div class="md:w-full flex flex-col justify-between mx-2 md:mx-4">
            <h4 class="hidden md:block text-lg md:text-xl mt-2 md:mt-0 font-semibold">
            ...
            <div class="flex flex-col items-start md:flex-row md:items-center justify-between mt-6">
                ...
                <div class="flex md:hidden items-center justify-between mt-4 w-full">
