<x-app-layout>
    <div>
        <a href="{{ route('/') }}" class="flex items-center font-semibold hover:underline">
            ...
            <div class="w-full mx-4">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div x-data="{ isOpen: false }" class="flex items-center space-x-2">
                        ...
                        <button @click.prevent="isOpen = ! isOpen" class="relative bg-gray-100 hover:bg-gray-200 border rounded-full h-7 focus:outline-none transition duration-150 ease-in py-2 px-3">
                            ...
                            <ul 
                                ...
                                class="absolute right-0 top-8 shadow-lg w-44 text-left font-semibold bg-white shadow-lg rounded-xl py-3"
                            >
        ...
        <div class="flex items-center space-x-4 ml-6">
            <div x-data="{ isOpen: false }" class="relative">
                <button
                    ...
                    type="button"
                    class="flex items-center justify-center h-11 w-32 text-sm bg-teal-500 text-white focus:outline-none font-semibold rounded-xl border border-blue hover:bbg-teal-600 transition duration-150 ease-in px-6 py-3"
                >
                    Reply
                </button>
            ...
            <div x-data="{ isOpen: false }" class="relative">
                <button
                    @click.prevent="isOpen = ! isOpen"
                    type="button"
                    class="flex items-center justify-center w-36 h-11 text-sm focus:outline-none bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-teal-500 transition duration-150 ease-in px-6 py-3"
                >
                ...
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-gray-600 focus:ring-gray-600 border-none" name="status" value="1" checked>
                                    <span class="ml-2">Open</span>
                                </label>
                            </div>
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-purple-500 focus:ring-purple-500 border-none" name="status" value="2">
                                    <span class="ml-2">Considering</span>
                                </label>
                            </div>
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-yellow-500 focus:ring-yellow-500 border-none" name="status" value="3">
                                    <span class="ml-2">In Progress</span>
                                </label>
                            </div>
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-green-500 focus:ring-green-500 border-none" name="status" value="3">
                                    <span class="ml-2">Implemented</span>
                                </label>
                            </div>
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-red-500 focus:ring-red-500 border-none" name="status" value="3">
                        ...
                        <div class="flex items-center justify-between space-x-3">
                            ...
                            <button
                                type="submit"
                                class="flex items-center justify-center w-1/2 h-11 text-xs bg-teal-500 text-white focus:outline-none font-semibold rounded-xl border border-blue hover:bg-teal-600 transition duration-150 ease-in px-6 py-3"
                            >
                        ...
                        <div>
                            <label class="font-normal inline-flex items-center">
                                <input type="checkbox" name="notify_voters" class="rounded text-teal-500 focus:ring-teal-500 bg-gray-200" checked="">
        ...
        <div class="is-admin comment-container relative bg-white rounded-xl flex mt-4">
            <div class="flex flex-1 px-4 py-6">
                ...
                <div class="w-full mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                            <div class="font-bold text-teal-500">Andrea</div>
                            <div>&bull;</div>
                            <div>10 hours ago</div>
                        </div>
                        <div class="flex items-center space-x-2">
